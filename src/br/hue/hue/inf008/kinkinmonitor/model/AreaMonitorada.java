...
public class AreaMonitorada {
    ...
    private int id;
    private String nome;
    private Collection<UnidadeMonitora> unidades = new ArrayList<>();
    ...
    public Collection<UnidadeMonitora> getUnidades() {
        return unidades;
    }

    public void setUnidades(Collection<UnidadeMonitora> unidades) {
